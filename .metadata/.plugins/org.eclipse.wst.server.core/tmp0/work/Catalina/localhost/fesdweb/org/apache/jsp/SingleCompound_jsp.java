 ...
 * Generated at: 2017-07-23 17:38:14 UTC
...
public final class SingleCompound_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("      \r\n");
      out.write("      function drawChart(bands) {\r\n");
      out.write("    \t  \r\n");
      out.write("    \t\r\n");
      out.write("    \t  \r\n");
      out.write("    \t//  $(\"#Bands\").append($(\"<option></option>\").val('All').html('All'));\r\n");
      out.write("     \t  $.each(bands, function (key, value) {\r\n");
      out.write("\r\n");
      out.write(" \t         $(\"#BandsFrom\").append($(\"<option></option>\").val(value.Index).html(value.Index));\r\n");
      out.write(" \t        $(\"#BandsTo\").append($(\"<option></option>\").val(value.Index).html(value.Index));\r\n");
      out.write(" \t \t        \r\n");
      out.write("     \t  });\r\n");
      out.write("     \t  \r\n");
      out.write("     \t drawBandChart(bands);\r\n");
      out.write("     \t  \r\n");
      out.write("          }\r\n");
      out.write("      \r\n");
      out.write("      \t  function drawBandChart(bands)\r\n");
      out.write("      \t  {\r\n");
      out.write("      \t\t\r\n");
      out.write("       \t  \r\n");
      ...
      out.write("      \t\t{\r\n");
      out.write("      \t\r\n");
      out.write("      \t\t  data.push({x:dx,y:bands[l].Energy.split(\", \")});\r\n");
      out.write("      \t\t}\r\n");
      out.write("      \t  /* [{\r\n");
      ...
      out.write("        \t\t      \r\n");
      out.write("        \t\t      error_y: {\r\n");
      out.write("        \t\t        array: weight.map(function(x) { return x ; }),\r\n");
      ...
      out.write("\t\r\n");
      out.write("\t});\r\n");
      out.write("\t$('#Bands').change(function() {\r\n");
      out.write("\t\r\n");
      out.write("\t\t\tcurrentBand=$(this).val();\r\n");
      out.write("\t\t       drawChartSingleBand($(this).val(),Compound.BandStructures,'');\r\n");
      out.write("\t\t       \r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t});\r\n");
      out.write("\t\t\r\n");
      out.write("\t$(\"#CompoundElements\").change(function() {\r\n");
      out.write("\t\tvar obj = JSON.parse($(this).val());\r\n");
      out.write("\t\tvar header = obj.Header;\r\n");
      out.write("\t\tvar partialEnergery = obj.PartialEnergy;\r\n");
      out.write("\t\t $(\"#Orbitals\").html(''); \r\n");
      out.write("\t\t    $(\"#Orbitals\").append($(\"<option></option>\").val(\"None\").html(\"None\"));\t\t\t\r\n");
      out.write("\t\t $.each(header, function (key, value) {\r\n");
      out.write("\t  \t         $(\"#Orbitals\").append($(\"<option></option>\").val(partialEnergery[key]).html(value));\r\n");
      out.write("\t  \t       });\r\n");
      out.write("\r\n");
      out.write("\t});\r\n");
      out.write("\t\r\n");
      out.write("\t$(\"#Orbitals\").change(function() {\r\n");
      out.write("\t\t\r\n");
      out.write("\t\tdrawChartSingleBand(currentBand,Compound.BandStructures,$(this).val());\r\n");
      out.write("\t});\r\n");
      out.write("\t\r\n");
      out.write("\t\r\n");
      out.write("});\r\n");
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write("function GetBandstructures()\r\n");
      out.write("{\r\n");
      out.write("\tvar bandsFrom=$(\"#BandsFrom\").val(),bandsTo =$(\"#BandsTo\").val(); \r\n");
      out.write("\tif(bandsFrom>bandsTo)\r\n");
      out.write("\t{\r\n");
      out.write("\t\talert(\"Bands from should be less than bands to.\");\r\n");
      out.write("\t\treturn;\r\n");
      out.write("\t}\r\n");
      out.write("\t$.get('BandStructureServlet', {\r\n");
      out.write("\t\tfrom: bandsFrom,\r\n");
      out.write("\t\tto: bandsTo,\r\n");
      out.write("\t\tid:Compound.Id\r\n");
      ...
      out.write("\t     \t\t  \r\n");
      out.write("\t\t  \t         $(\"#CompoundElements\").append($(\"<option></option>\").val(JSON.stringify({Header: value.Header,PartialEnergy:value.PartialEnergy})).html(value.Element+\" \"+value.ElementIndex));\r\n");
      out.write("\t\t  \t       });\r\n");
      out.write("\t     \t  \r\n");
      out.write("\t     \t  \r\n");
      out.write("\r\n");
      ...
      out.write("\t  \r\n");
      out.write("\r\n");
      out.write("    \t drawChart(Compound.BandStructures);\r\n");
      out.write("    \t});\r\n");
      out.write("}\r\n");
      out.write("\r\n");
      out.write("\r\n");
      ...
      out.write("<td colspan=2>\r\n");
      out.write(" \r\n");
      out.write("Automated DFT calculations on <span style=\"color: red;\">80000</span> f-electron compounds\r\n");
      out.write("</td>\r\n");
      out.write("\r\n");
      out.write("</tr>\r\n");
      out.write("\r\n");
      ...
      out.write("        <div class=\"modal-body\">\r\n");
      out.write("    <div>\r\n");
      out.write("    <label  class=\"control-label \">Bandstructures</label> <input id=\"AllBandstructures\" type=\"checkbox\" value=\"All\">\r\n");
      out.write("\t\t\r\n");
      out.write("\t</div>\t\r\n");
      out.write("\t<div>\r\n");
      out.write("\t\r\n");
      out.write("\t<label  class=\"control-label \">From</label> <select style=\"width: 150px; \"  id=\"BandsFrom\">\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t</select>\r\n");
      out.write("\t\t<label  class=\"control-label \">To</label> <select style=\"width: 150px; \"  id=\"BandsTo\">\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t</select>\r\n");
      out.write("\t\t\r\n");
      out.write("\t</div>\r\n");
      out.write("\t<button style=\"width:180px;\" class=\"btn btn-secondary\" onclick=\"GetBandstructures()\">Get BandStructures</button>\r\n");
      out.write("\t\r\n");
      out.write("   <div id=\"BandChart\" style=\"width: 900px; height: 500px\"></div>\r\n");
      out.write("   \r\n");
      out.write("   \r\n");
      out.write(" <label  class=\"control-label \">Element </label> <select style=\"width: 100px; \"  id=\"CompoundElements\">\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t</select> \r\n");
      out.write("\t\t<label  class=\"control-label \">Orbital</label> <select style=\"width: 150px; \"  id=\"Orbitals\">\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t</select>\r\n");
